...
func (i *InventoryIcons) Layout() *fyne.Container {
	i.bowTapContainer = container.New(layout.NewCenterLayout(), i.bowTapIcon)
	i.bowNonProgressiveTapContainer = container.New(layout.NewCenterLayout(), i.bowNonProgressiveTapIcon)
	i.blueBoomerangTapContainer = container.New(layout.NewCenterLayout(), i.blueBoomerangTapIcon)
	i.redBoomerangTapContainer = container.New(layout.NewCenterLayout(), i.redBoomerangTapIcon)
	i.hookshotTapContainer = container.New(layout.NewCenterLayout(), i.hookshotTapIcon)
	i.bombTapContainer = container.New(layout.NewCenterLayout(), i.bombTapIcon)
	mushroomTapContainedIcon := i.mushroomTapIcon.LayoutAdjust()
	i.mushroomTapContainer = container.New(layout.NewCenterLayout(), mushroomTapContainedIcon)
	magicPowderTapContainedIcon := i.magicPowderTapIcon.LayoutAdjust()
	i.magicPowderTapContainer = container.New(layout.NewCenterLayout(), magicPowderTapContainedIcon)
	i.fireRodTapContainer = container.New(layout.NewCenterLayout(), i.fireRodTapIcon)
	i.iceRodTapContainer = container.New(layout.NewCenterLayout(), i.iceRodTapIcon)
	bombosTapContainedIcon := i.bombosTapIcon.LayoutAdjust()
	i.bombosTapContainer = container.New(layout.NewCenterLayout(), bombosTapContainedIcon)
	etherTapContainedIcon := i.etherTapIcon.LayoutAdjust()
	i.etherTapContainer = container.New(layout.NewCenterLayout(), etherTapContainedIcon)
	quakeTapContainedIcon := i.quakeTapIcon.LayoutAdjust()
	i.quakeTapContainer = container.New(layout.NewCenterLayout(), quakeTapContainedIcon)
	i.lampTapContainer = container.New(layout.NewCenterLayout(), i.lampTapIcon)
	i.hammerTapContainer = container.New(layout.NewCenterLayout(), i.hammerTapIcon)
	fluteTapContainedIcon := i.fluteTapIcon.LayoutAdjust()
	i.fluteTapContainer = container.New(layout.NewCenterLayout(), fluteTapContainedIcon)
	shovelTapContainedIcon := i.shovelTapIcon.LayoutAdjust()
	i.shovelTapContainer = container.New(layout.NewCenterLayout(), shovelTapContainedIcon)
	i.bugNetTapContainer = container.New(layout.NewCenterLayout(), i.bugNetTapIcon)
	i.bookOfMudoraTapContainer = container.New(layout.NewCenterLayout(), i.bookOfMudoraTapIcon)
	bottleTotalTapContainedIcon := i.bottleTotalTapIcon.LayoutAdjust()
	i.bottleTotalTapContainer = container.New(layout.NewCenterLayout(), bottleTotalTapContainedIcon)
	i.bottle1TapContainer = container.New(layout.NewCenterLayout(), i.bottle1TapIcon)
	i.bottle2TapContainer = container.New(layout.NewCenterLayout(), i.bottle2TapIcon)
	i.bottle3TapContainer = container.New(layout.NewCenterLayout(), i.bottle3TapIcon)
	i.bottle4TapContainer = container.New(layout.NewCenterLayout(), i.bottle4TapIcon)
	i.caneOfSomariaTapContainer = container.New(layout.NewCenterLayout(), i.caneOfSomariaTapIcon)
	i.caneOfByrnaTapContainer = container.New(layout.NewCenterLayout(), i.caneOfByrnaTapIcon)
	i.magicCapeTapContainer = container.New(layout.NewCenterLayout(), i.magicCapeTapIcon)
	i.magicMirrorTapContainer = container.New(layout.NewCenterLayout(), i.magicMirrorTapIcon)
	i.pseudoPegasusBootsTapContainer = container.New(layout.NewCenterLayout(), i.pseudoPegasusBootsTapIcon)
	i.pegasusBootsTapContainer = container.New(layout.NewCenterLayout(), i.pegasusBootsTapIcon)
	i.glovesTapContainer = container.New(layout.NewCenterLayout(), i.glovesTapIcon)
	i.flippersTapContainer = container.New(layout.NewCenterLayout(), i.flippersTapIcon)
	i.moonPearlTapContainer = container.New(layout.NewCenterLayout(), i.moonPearlTapIcon)
	i.swordTapContainer = container.New(layout.NewCenterLayout(), i.swordTapIcon)
